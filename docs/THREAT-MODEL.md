...
- **Retention is implemented, and what it does not bound is the audit records.** An
  event's content is deleted thirty days after the event ends, with a notice from day 23
